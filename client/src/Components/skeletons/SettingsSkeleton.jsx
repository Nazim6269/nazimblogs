        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-10 mb-6 sm:mb-12">
            ...
            <div className="space-y-3 text-center md:text-left w-full">
              <div className={`h-8 sm:h-10 md:h-12 w-48 sm:w-64 md:w-80 rounded mx-auto md:mx-0 ${bg}`} />
              <div className={`h-4 sm:h-5 w-full max-w-96 rounded mx-auto md:mx-0 ${bg}`} />
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className={`h-28 sm:h-32 w-full rounded-md ${bg}`} />
            </div>
          </div>
