...
const SearchPopup = () => {
  return (
    <section className="absolute left-0 top-0 w-full h-full grid place-items-center bg-slate-800/50 backdrop-blur-sm z-50">
      {/* <!-- Search Container --> */}
      <div className="relative w-6/12 mx-auto bg-slate-900 p-4 border border-slate-600/50 rounded-md shadow-md shadow-slate-400/10">
        {/* <!-- Search --> */}
        <div>
          ...
          <input
            ...
            className="w-full bg-transparent p-2 text-base text-white outline-none border-none rounded-md focus:ring focus:ring-indigo-600"
          />
        </div>
        ...
        <a href="./index.html">
          <FontAwesomeIcon
            icon={faXmark}
            alt="Close"
            className="absolute right-2 top-2 text-white border-2  border-white rounded-full cursor-pointer w-7 h-7"
          />
        </a>
      </div>
    </section>
